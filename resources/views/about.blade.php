...
@section('content')
    <!-- About Section -->
    <div class="md:col-span-12 bg-blue-50 p-8 rounded-lg shadow-md">
    ...
    <!-- Vision Section -->
    <div class="md:col-span-12 bg-blue-50 p-8 mt-8 rounded-lg shadow-md">
        <div class="text-center">
    ...
    <div class="md:col-span-12 bg-blue-600 text-white p-8 mt-8 rounded-lg shadow-md">
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8">
            @foreach(['Dr. Emily Clark - Dentist', 'John Doe - Hygienist', 'Sarah Williams - Assistant'] as $member)
                <div class="bg-blue-50 text-center shadow-md rounded-lg p-6">
                    <img
                    ...
                    <p class="mt-2 text-blue-800">Dedicated to providing exceptional patient care.</p>
                </div>
            @endforeach
        </div>
    </div>
